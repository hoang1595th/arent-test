  ...
  return (
    <div className="relative w-[136px] h-[136px]">
      ...
      <div
        ...
        style={{
          clipPath:
            'polygon(50% 0%, 93.301% 25%, 93.301% 75%, 50% 100%, 6.699% 75%, 6.699% 25%)',
        }}
      >
        {/* Fill */}
        <div className="absolute inset-0 bg-gradient-to-tr from-[#FFCC21] to-[#FF963C]" />
        ...
        <div className="relative z-10 h-full w-full flex flex-col items-center justify-center text-white">
            ...
            {icon === 'meal' && (
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clip-path="url(#clip0_0_713)">
                  <g clip-path="url(#clip1_0_713)">
                    <path d="M11.0234 46.2289C9.9344 47.316 9.93623 49.0846 11.0288 50.1788C12.123 51.2714 13.8917 51.2731 14.9805 50.1844L23.6829 41.4821L19.7255 37.525L11.0234 46.2289Z" fill="white" />
          ...
          {/* Label */}
          <span className="text-white text-sm leading-none">{label}</span>
        </div>
      </div>
    </div>
  );
